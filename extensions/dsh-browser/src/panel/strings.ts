...
const EN: PanelCopy = {
  ...
  tabHandoff: {
    ...
    questionTitle: 'Should the assistant follow you?',
    ...
    keep: 'Continue original page',
    follow: 'Follow this page',
    backgroundTitle: (controlled) => `Continuing on “${controlled}”`,
